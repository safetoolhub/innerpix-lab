...
# PyInstaller spec for InnerPix Lab
...
# ── macOS: exclude unnecessary Qt libs to shrink the bundle ──────────────────
excludes = [
    "PyQt6.QtBluetooth",
    "PyQt6.QtNfc",
    "PyQt6.QtPositioning",
...
if sys.platform == "darwin":
    ...
    app = BUNDLE(
        coll,
        name="InnerPixLab.app",
        icon=str(ROOT / "assets" / "icon.icns"),
        bundle_identifier="org.safetoolhub.innerpixlab",
        version=VERSION,
        info_plist={
