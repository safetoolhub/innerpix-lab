; Inno Setup script for InnerPix Lab
; Generates a single-file installer: InnerPixLab-{version}-windows-setup.exe
;
; Build with:
...
#define AppName    "Innerpix Lab"
#define AppPublisher "SafeToolHub"
#define AppURL     "https://safetoolhub.org"
#define AppExeName "InnerPixLab.exe"

; Paths relative to this script (which lives in build/)
#define RootDir    ".."
#define SourceDir  "..\dist\InnerPixLab"
#define OutputDir  "..\dist"
#define OutputFile "InnerPixLab-{#APP_FULL_VERSION}-windows-setup"
