...
class Config:
    ...
    TOOL_ANALYSIS_COST = {
        ...
        "exact_duplicates": "fast",    # < 5 segundos
        "organize": "fast",            # < 5 segundos
        "rename": "fast",              # < 5 segundos
        "similar_duplicates": "expensive"  # Varios minutos
    }
    ...
    TOOL_IMPACT_ON_FILES = {
        ...
        "exact_duplicates": "destructive", # Elimina copias exactas
        "similar_duplicates": "destructive", # Elimina archivos similares
    ...
    TOOL_DISPLAY_NAMES = {
        ...
        "similar_duplicates": "Duplicados Similares",
