...
class Phase3(BasePhase):
    ...
    def setup_ui(self) -> None:
        """Configura la interfaz de usuario de la Fase 3."""
        self.logger.info("Configurando UI de la Fase 3")

        # Crear y mostrar summary card con delay
        QTimer.singleShot(300, self._show_summary_card)

        self.logger.info("UI de la Fase 3 configurada")

    def cleanup(self) -> None:
        """Limpia los recursos del Estado 3."""
