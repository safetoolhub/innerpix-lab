"""
Clase base para las fases de la interfaz de usuario.
...
class BasePhase(QObject):
    """
    Clase base abstracta para todas las fases de la UI.
    Define la interfaz común y proporciona utilidades compartidas.
    """

    def __init__(self, main_window: QMainWindow):
        """
        Inicializa la fase base.
        ...
        self.logger = get_logger(f'UI.Phase.{self.__class__.__name__}')
