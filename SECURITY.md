...
3. Your OS and InnerPix Lab version
...
InnerPix Lab is a **100% offline, local desktop application**. It makes no network connections and stores no data outside your machine. As a result:
...
Thank you for helping keep InnerPix Lab and its users safe.
