...
def test_heic_analysis_logic(heic_service, mock_repo):
    ...
    with patch('utils.date_utils.get_best_creation_date', return_value=(dt, dt, 'EXIF')):
    ...
    with patch('utils.date_utils.get_best_creation_date', return_value=(dt_heic, dt_jpg, 'EXIF')):
        result = heic_service.analyze(validate_dates=True)
    ...
    with patch('utils.date_utils.get_best_creation_date', return_value=None):
        result = heic_service.analyze(validate_dates=True)
